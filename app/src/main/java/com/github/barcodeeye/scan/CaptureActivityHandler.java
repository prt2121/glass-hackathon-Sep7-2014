...
import com.intellibins.recyclethis.CaptureActivity;
import com.intellibins.recyclethis.R;

import java.util.Collection;
import java.util.Map;

/**
 * This class handles all the messaging
 * which comprises the state machine for capture.
 *
